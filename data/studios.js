...
const studios = [
  ...
  {
    id: 'school-art-tokyo-bunkyo-sendagi-petarts',
    listingType: 'school',
    name: '千駄木絵画教室（開講準備中）',
    entityType: 'EducationalOrganization',
    entityId: 'https://www.lesson-map.com/#school-art-tokyo-bunkyo-sendagi-petarts',
    prefecture: '東京都',
    addressLocality: '文京区',
    officialUrl: 'https://petarts.endswell.net/',
    description: 'ペットの肖像画制作を手がけるペットアーツが、千駄木ショールームで開講を計画している絵画教室です。開講日・対象・レッスン内容・料金・申込方法は未発表のため、最新情報を公式サイトで確認してください。',
    category: 'Art',
    city: '文京区',
    area: '千駄木駅周辺',
    access: '東京都文京区千駄木2丁目33-4／東京メトロ千代田線 千駄木駅1番出口から約50m',
    genres: ['Art', 'Painting', 'Pet Portrait'],
    learningNeeds: ['art_learning'],
    decisionFactors: ['opening_status', 'class_content', 'schedule_fit'],
    fitSummary: '千駄木で今後開講予定の絵画教室について最新情報を確認したい人向け',
    checkpoints: ['正式な開講日', '対象・レッスン内容', '料金・申込方法'],
    pricing: { system: '未発表', minPrice: 0, note: '絵画教室の料金は未発表。最新情報は公式サイトで確認' },
    features: { parking: false, beginnerFriendly: '未確認', kidsClass: false, adultClass: false },
    scheduleNote: '絵画教室の開講日時は未発表',
    trial: '体験・見学条件は未発表',
    imageUrl: 'https://images.unsplash.com/photo-1549490349-8643362247d7?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
    link: 'https://petarts.endswell.net/',
    sourceNote: '掲載依頼および公式サイトを2026-09-05確認。開講準備中として掲載'
  },
  {
    id: 'school-kendo-niigata-nagaoka-kesajiro',
    listingType: 'school',
    name: '今朝白剣友会',
    entityType: 'SportsOrganization',
    entityId: 'https://www.lesson-map.com/#school-kendo-niigata-nagaoka-kesajiro',
    prefecture: '新潟県',
    addressLocality: '長岡市',
    description: '新潟県長岡市で、幼児から大人まで参加できる剣道の稽古会です。初心者・未経験者や、久しぶりに剣道を再開したい人も歓迎。剣道の技術に加え、挨拶や礼儀、集中力、体力を身につけられるよう、明るく和やかな雰囲気で稽古しています。',
    category: 'Kendo',
    city: '長岡市',
    area: '長岡市内',
    access: '新潟県長岡市／借用会場のため、稽古場所と日時は事前確認が必要',
    genres: ['Kendo', 'Kids', 'Adult', 'Beginner', 'Returner'],
    learningNeeds: ['kids_lessons', 'adult_lessons', 'sports_learning'],
    decisionFactors: ['beginner_friendly', 'trial_available', 'schedule_fit'],
    fitSummary: '長岡市で剣道を始めたい幼児から大人、または久しぶりに再開したい人向け',
    checkpoints: ['稽古会場・日時', '見学・体験できる日', '用意する剣道具'],
    pricing: { system: '無料', minPrice: 0, note: '会費・稽古料は無料。剣道具は各自で用意' },
    features: { parking: false, beginnerFriendly: '◎', kidsClass: true, adultClass: true, weekendOpen: true },
    scheduleNote: '土日に稽古。借用会場のため、場所と日時は事前確認が必要',
    trial: '見学・体験ともに可能。参加できる日時は要問い合わせ',
    imageUrl: 'https://images.unsplash.com/photo-1555597673-b21d5c935865?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
    sourceNote: '掲載依頼者から提供された現行情報を2026-09-05確認。問い合わせ先は未提出'
  },
  {
  ...
  },
  {
    ...
    imageUrl: '/assets/schools/switch-nagoya-sakae/classroom.png', imageAlt: 'Switch名古屋栄校の教室全景',
    gallery: [
      { src: '/assets/schools/switch-nagoya-sakae/lesson-01.png', alt: 'Switch名古屋栄校で教材とパソコンを使って学ぶ授業風景' },
      { src: '/assets/schools/switch-nagoya-sakae/lesson-02.png', alt: 'Switch名古屋栄校でMinecraftを使って学ぶ授業風景' },
      { src: '/assets/schools/switch-nagoya-sakae/lesson-03.png', alt: 'Switch名古屋栄校の少人数制レッスンの様子' },
      { src: '/assets/schools/switch-nagoya-sakae/lesson-04.png', alt: 'Switch名古屋栄校で生徒がパソコンに取り組む授業風景' }
    ],
    link: 'https://lp.db.child-leader-pro.com/p/switch-nagoya-sakae-trial', sourceNote: '公式ページを2026-09-09確認。対象・日時・料金・電話番号・教室特徴・提供写真5点は教室提供情報を2026-09-12反映'
  },
  {
